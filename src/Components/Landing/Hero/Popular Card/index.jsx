...
const index = ({ list }) => {
    return (
        <div className='w-full'>
            {list.map((anime, i) => {
                return (
                    <div className='w-full px-2 mb-6 cursor-pointer group' key={anime + i}>
                        <div className='relative'>
                            <img loading="lazy" src={anime.images.webp.large_image_url} draggable={false} className='sm:h-[200px] sm:w-full h-[200px] w-full object-cover rounded-lg mb-2' alt="" />
                            ...
                            <div className="absolute px-2 flex flex-col justify-center bottom-0 w-full rounded-b-lg 
                                ...
                                <h1 className="text-white text-lg font-[500]">{anime.title_english}</h1>
                            </div>
